...
class JwtTokenProviderTest {
    ...
    class GenerateTokenTests {
        ...
        void generateToken_ValidInput_ReturnsNonBlankToken() {
            ...
            String token = jwtTokenProvider.generateToken(auth, "default", 1L);
        ...
        void generateToken_TenantIdRoundTrip() {
            Authentication auth = mockAuthentication("user@example.com");
            String token = jwtTokenProvider.generateToken(auth, "tenant-abc", 1L);
        ...
        void generateToken_DifferentUsers_DifferentTokens() {
            String token1 = jwtTokenProvider.generateToken(mockAuthentication("alice@test.com"), "default", 1L);
            String token2 = jwtTokenProvider.generateToken(mockAuthentication("bob@test.com"), "default", 2L);
        ...
        void generateToken_DifferentTenants_DifferentTokens() {
            ...
            String token1 = jwtTokenProvider.generateToken(auth, "tenant-A", 1L);
            String token2 = jwtTokenProvider.generateToken(auth, "tenant-B", 1L);
    ...
    class GenerateTokenFromUsernameTests {
        ...
        void generateTokenFromUsername_ValidUsername_ReturnsToken() {
            String token = jwtTokenProvider.generateToken("refresh@example.com", "default", 1L, List.of("ROLE_USER"));
        ...
        void generateTokenFromUsername_UsernameRoundTrip() {
            ...
            String token = jwtTokenProvider.generateToken(username, "default", 1L, List.of("ROLE_USER"));
        ...
        void generateTokenFromUsername_NoTenantIdClaim() {
            String token = jwtTokenProvider.generateToken("user@test.com", "default", 1L, List.of("ROLE_USER"));
    ...
    class ValidateTokenTests {
        ...
        void validateToken_ExpiredToken_ReturnsFalse() {
            ...
            String expiredToken = expiredProvider.generateToken("user@test.com", "default", 1L, List.of("ROLE_USER"));
        ...
        void validateToken_TamperedSignature_ReturnsFalse() {
            ...
            String tokenFromOtherKey = otherProvider.generateToken("user@test.com", "default", 1L, List.of("ROLE_USER"));
    ...
    class GetUsernameTests {
        ...
        void getUsername_ValidToken_ReturnsCorrectUsername() {
            String token = jwtTokenProvider.generateToken("alice@company.com", "default", 1L, List.of("ROLE_USER"));
    ...
    class GetTenantIdTests {
        ...
        void getTenantIdFromToken_WithTenantClaim_ReturnsCorrectId() {
            Authentication auth = mockAuthentication("user@test.com");
            String token = jwtTokenProvider.generateToken(auth, "hdfc-tenant", 1L);
